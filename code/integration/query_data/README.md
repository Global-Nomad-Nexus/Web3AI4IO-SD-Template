# integration / query_data

Acquire exact archived inputs and verify bytes; for the real study implement and document bounded live collection separately.

Run from the repository root:

```bash
python3 code/integration/query_data/run.py --workdir outputs/demo
```
