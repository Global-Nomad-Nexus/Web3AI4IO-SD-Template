# integration / technical_validation

Check software outputs and provide independent scientific evidence for actual data quality.

Run from the repository root:

```bash
python3 code/integration/technical_validation/run.py --workdir outputs/demo
```
